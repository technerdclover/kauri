...
\
**Arguments:**\
<kbd>**text**</kbd> <sup><kbd><mark style="color:green;background-color:green;">Req<mark style="color:green;background-color:green;"><kbd></sup> Expects any [String <sup><kbd>str<kbd></sup>](in-depth-explanation.md#string-str), expression, or [Variable <sup><kbd>var<kbd></sup>](in-depth-explanation.md#variable-var). You can string together multiple `text` arguments by separating them with commas.\
\
**Examples:**\
